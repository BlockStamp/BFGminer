...
#ifdef VECTORS4
	bool result = (W[117].x ^ 0x00000080) & (W[117].y ^ 0x00000080) & (W[117].z ^ 0x00000080) & (W[117].w ^ 0x00000080);
	if (!result) {
		if (W[117].x==0x00000080)
			SETFOUND(W[3].x);
		if (W[117].y==0x00000080)
			SETFOUND(W[3].y);
		if (W[117].z==0x00000080)
			SETFOUND(W[3].z);
		if (W[117].w==0x00000080)
			SETFOUND(W[3].w);
	}
#elif defined VECTORS2
	bool result = (W[117].x ^ 0x00000080) & (W[117].y ^ 0x00000080);
	if (!result) {
		if (W[117].x==0x00000080)
			SETFOUND(W[3].x);
		if (W[117].y==0x00000080)
